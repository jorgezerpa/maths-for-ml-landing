            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-12">
                ...
                <div className="space-y-8 md:grid md:grid-cols-3 md:gap-12 md:space-y-0">
                    ...
                    <div>
                        ...
                        <p className="text-gray-200 dark:text-gray-400">
                            Si tienes discusiones con tus amigos de que si Skynet nos va a dominar o no, esta formacion es para ti.
                        </p>
                    </div>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-12">
            ...
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    <div className='w-full h-64 bg-gray-200 mb-2 justify-center items-center flex'>
